...
const services: Service[] = [
  ...
  },
  {
    ...
    badge: 'AI-Powered',
    badgeClass: 'badge-digital',
    title: 'AI-Powered Content Repurposing & Distribution Platform',
    price: '$4,000 - $12,000',
    priceUnit: 'month',
    timeline: 'Ongoing',
    perfectFor: 'Content creators, coaches, agencies, businesses creating video/podcast content',
    description: 'Transform 1 piece of content into 40-50 distribution-ready assets across 15+ platforms automatically. Save 60-95 hours/month while reaching 10-20x more people.',
    includes: [
      '4-16 content pieces transformed per month (based on tier)',
      '40-240 unique assets created (videos, blogs, social posts, emails, lead magnets)',
      'Distribution to 15+ platforms (YouTube, Instagram, TikTok, LinkedIn, Twitter, Facebook, Medium, blog, email)',
      ...
      'Strategy calls (Professional & Enterprise tiers)',
      'Dedicated account manager (Enterprise tier)'
    ],
    deliverables: [
      '15-18 short-form video clips (Reels, TikToks, Shorts)',
      '8-10 blog posts and articles (800-1,200 words each)',
      '25-30 social media posts with graphics',
      '5-6 email content pieces (newsletters, promotions)',
      '1-2 lead magnets (ebooks, checklists)',
      'Multi-platform distribution',
      'Performance analytics and reporting',
      'Content calendar management'
    ],
    successMetrics: [
      '10-20x increase in content output',
      '60-95 hours/month time savings',
      '150-300% increase in reach and engagement',
      '50-200% increase in lead generation',
      '47K-191K monthly views (per content piece)',
      '133-470 leads/month (per content piece)',
      'ROI: 592-11,074%'
    ],
    contractTerms: [
      'For the first month, a 50% deposit is required',
      ...
      'Payment: Monthly, invoiced on the 1st',
      'Cancellation: 30-day notice required',
      '30-day performance guarantee: If we don\'t deliver at least 40 unique, high-quality assets in your first month, we\'ll work for FREE until we do'
    ],
    potentialROI: '592-11,074% ROI - Save $15,200-$23,950/month in time value + generate $30,000-$423,000/month in new revenue from increased leads and visibility'
  },
  // PR Services
  {
    id: 'launch-pad',
  ...
  },
  {
    ...
    includes: [
      ...
      'AI-Powered Content Repurposing ($4,000/month)'
    ],
    deliverables: [
  ...
  },
  {
    ...
    includes: [
      ...
      'AI-Powered Content Repurposing ($7,000/month)'
    ],
    deliverables: [
